            ...
            datasets: [
                {
                    ...
                    borderColor: "rgba(75, 192, 192, 1)", // Border color (you can adjust this)
                    borderWidth: 1,
                },
            ],
        },
    ...
    buttons.forEach((button, index) => {
        button.addEventListener("mousedown", (e) => {
            ...
            const onMouseMove = (e) => {
                ...
                const sliderButtonAPosition0 = parseInt (( (buttons[0].getBoundingClientRect().left - sliderRect.left) /  sliderRect.width) * maxMarks);
                ...
                const sliderButtonAPosition7 = parseInt(( (buttons[7].getBoundingClientRect().left - sliderRect.left) /  sliderRect.width) * maxMarks);
